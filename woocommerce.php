...
if ( chandelier_elated_options()->getOptionValue('eltd_woo_products_list_full_width') == 'yes' && !is_singular('product') ) {
	$full_width = true;
}

if ( $full_width ) { ?>
	<div class="eltd-full-width" <?php chandelier_elated_inline_style($background_color); ?>>
<?php } else { ?>
	<div class="eltd-container" <?php chandelier_elated_inline_style($background_color); ?>>
<?php }
		if ( $full_width ) { ?>
			<div class="eltd-full-width-inner" <?php chandelier_elated_inline_style($content_style); ?>>
		<?php } else { ?>
			<div class="eltd-container-inner clearfix" <?php chandelier_elated_inline_style($content_style); ?>>
		<?php }
			...
			if ( ! is_singular('product') ) {
				...
				switch( $sidebar ) {
						...
						<div class="eltd-two-columns-66-33 grid2 eltd-woocommerce-with-sidebar clearfix">
							<div class="eltd-column1">
								<div class="eltd-column-inner">
									<?php chandelier_elated_woocommerce_content(); ?>
								</div>
							</div>
					...
					<?php
						break;
					default:
						chandelier_elated_woocommerce_content();
				}
