 ...
 */
if (!class_exists('ChandelierStickyNavigationWalker')) {
	class ChandelierStickyNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			// build html
			$output .= $indent . '<li id="sticky-menu-item-'. $item->ID . '" class="' . $class_names . ' '. $active . $sub . $menu_type . $wide_menu_position .'">';
