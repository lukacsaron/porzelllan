...
if ( ! function_exists('chandelier_elated_page_options_map') ) {

    function chandelier_elated_page_options_map() {
        ...
        $panel_sidebar = chandelier_elated_add_admin_panel(
            array(
                'page'  => '_page_page',
                'name'  => 'panel_sidebar',
                'title' => 'Design Style'
    ...
    add_action( 'chandelier_elated_options_map', 'chandelier_elated_page_options_map', 9);
