...
if ( ! function_exists('chandelier_elated_fonts_options_map') ) {
	/**
	 * Font options page
	 */
	function chandelier_elated_fonts_options_map() {
		 ...
		 * Headings
		 */
		$panel_headings = chandelier_elated_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_headings',
				'title' => 'Headings'
		...
		//H1
		$group_heading_h1 = chandelier_elated_add_admin_group(array(
		...
		$row_heading_h1_1 = chandelier_elated_add_admin_row(array(
		...
		$row_heading_h1_2 = chandelier_elated_add_admin_row(array(
		...
		//H2
		$group_heading_h2 = chandelier_elated_add_admin_group(array(
		...
		$row_heading_h2_1 = chandelier_elated_add_admin_row(array(
		...
		$row_heading_h2_2 = chandelier_elated_add_admin_row(array(
		...
		//H3
		$group_heading_h3 = chandelier_elated_add_admin_group(array(
		...
		$row_heading_h3_1 = chandelier_elated_add_admin_row(array(
		...
		$row_heading_h3_2 = chandelier_elated_add_admin_row(array(
		...
		//H4
		$group_heading_h4 = chandelier_elated_add_admin_group(array(
		...
		$row_heading_h4_1 = chandelier_elated_add_admin_row(array(
		...
		$row_heading_h4_2 = chandelier_elated_add_admin_row(array(
		...
		//H5
		$group_heading_h5 = chandelier_elated_add_admin_group(array(
		...
		$row_heading_h5_1 = chandelier_elated_add_admin_row(array(
		...
		$row_heading_h5_2 = chandelier_elated_add_admin_row(array(
		...
		//H6
		$group_heading_h6 = chandelier_elated_add_admin_group(array(
		...
		$row_heading_h6_1 = chandelier_elated_add_admin_row(array(
		...
		$row_heading_h6_2 = chandelier_elated_add_admin_row(array(
		 ...
		 * Text
		 */
		$panel_text = chandelier_elated_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_text',
				'title' => 'Text'
		...
		$group_text = chandelier_elated_add_admin_group(array(
			'name'			=> 'group_text',
			'title'			=> 'Paragraph',
		...
		$row_text_1 = chandelier_elated_add_admin_row(array(
			'name'		=> 'row_text_1',
			'parent'	=> $group_text
		));
		...
		$row_text_2 = chandelier_elated_add_admin_row(array(
			'name'		=> 'row_text_2',
			'parent'	=> $group_text,
			'next'		=> true
		));
		...
		$group_link = chandelier_elated_add_admin_group(array(
			'name'			=> 'group_link',
			'title'			=> 'Links',
		...
		$row_link_1 = chandelier_elated_add_admin_row(array(
			'name'		=> 'row_link_1',
			'parent'	=> $group_link
		));
		...
		$row_link_2 = chandelier_elated_add_admin_row(array(
			'name'		=> 'row_link_2',
			'parent'	=> $group_link,
			'next'		=> true
		));
		...
		chandelier_elated_add_admin_field(array(
			...
			'options'		=> chandelier_elated_get_text_decorations(),
			'parent'		=> $row_link_2
		));
	...
	add_action( 'chandelier_elated_options_map', 'chandelier_elated_fonts_options_map', 16);
