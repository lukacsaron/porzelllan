...
if ( ! function_exists('chandelier_elated_sidebar_options_map') ) {

	function chandelier_elated_sidebar_options_map() {
		...
		$panel_widgets = chandelier_elated_add_admin_panel(
			array(
				'page'  => '_sidebar_page',
				'name'  => 'panel_widgets',
				'title' => 'Widgets'
		...
		$group_sidebar_padding = chandelier_elated_add_admin_group(array(
			'name'		=> 'group_sidebar_padding',
			'title'		=> 'Padding',
			'parent'	=> $panel_widgets
		));

		$row_sidebar_padding = chandelier_elated_add_admin_row(array(
	...
	add_action( 'chandelier_elated_options_map', 'chandelier_elated_sidebar_options_map', 11);
