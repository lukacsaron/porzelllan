...
add_action('after_setup_theme', 'chandelier_elated_admin_map_init', 0);

function chandelier_elated_admin_map_init() {

    do_action('chandelier_elated_before_options_map');
    ...
    do_action('chandelier_elated_options_map');

    do_action('chandelier_elated_after_options_map');
