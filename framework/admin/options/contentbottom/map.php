...
if ( ! function_exists('chandelier_elated_content_bottom_options_map') ) {

	function chandelier_elated_content_bottom_options_map() {
		...
		$panel_content_bottom = chandelier_elated_add_admin_panel(
			array(
		...
		$enable_content_bottom_area_container = chandelier_elated_add_admin_container(
			array(
				'parent'            => $panel_content_bottom,
	...
	add_action( 'chandelier_elated_options_map', 'chandelier_elated_content_bottom_options_map', 10);
