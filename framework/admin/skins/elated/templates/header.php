<div class="eltd-page-header page-header clearfix">
    ...
    <div class="eltd-theme-name pull-left" >
        <img src="<?php echo esc_url(chandelier_elated_get_skin_uri() . '/assets/img/logo.png'); ?>" alt="eltd_logo" class="eltd-header-logo pull-left"/>
        ...
        <div class="eltd-top-section-holder-inner">
            ...
            <div class="eltd-top-buttons-holder">
                <?php if($show_save_btn) { ?>
                    <input type="button" id="eltd_top_save_button" class="btn btn-info btn-sm" value="<?php esc_html_e('Save Changes', 'chandelier'); ?>"/>
                <?php } ?>
            </div>
