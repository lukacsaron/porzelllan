...
/*
  Class: ChandelierIconCollections
...
class ChandelierIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new ChandelierIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new ChandelierIconsFontElegant("Font Elegant", "fe_icon"));
        $this->addIconCollection('ion_icons', new ChandelierIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new ChandelierLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('simple_line_icons', new ChandelierSimpleLineIcons('Simple Line Icons',
            'simple_line_icons'));
        $this->addIconCollection('dripicons', new ChandelierDripicons('Dripicons', 'dripicon'));
    }
    ...
    public function getIconCollectionIcons(iChandelierIconCollection $collection) {
...
$chandelier_elated_IconCollections = ChandelierIconCollections::get_instance();