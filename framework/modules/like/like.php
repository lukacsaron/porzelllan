<?php
class ChandelierLike {

	private static $instance;

	private function __construct() {
		add_action('wp_enqueue_scripts', array( $this, 'enqueue_scripts'));
		add_action('wp_ajax_chandelier_elated_like', array( $this, 'ajax'));
		add_action('wp_ajax_nopriv_chandelier_elated_like', array( $this, 'ajax'));
	}
	...
	public function add_like() {
		...
		$class = 'eltd-like';
		$title = esc_html__('Like this', 'chandelier');
		if( isset($_COOKIE['eltd-like_'. $post->ID]) ){
			$class = 'eltd-like liked';
			$title = esc_html__('You already like this!', 'chandelier');
		}
...
global $chandelier_elated_like;
$chandelier_elated_like = ChandelierLike::get_instance();
