<?php if(chandelier_elated_options()->getOptionValue('blog_single_navigation') == 'yes'){

	$prev_post = get_previous_post();
	$next_post = get_next_post();
	$navigation_blog_through_category = chandelier_elated_options()->getOptionValue('blog_navigation_through_same_category')
	?>
				...
				<div class="eltd-blog-single-prev-holder">
					...
					if(has_post_thumbnail($prev_post->ID)){?>
						<div class="eltd-blog-single-prev">
							<?php
							$prev_post_image = get_the_post_thumbnail($prev_post->ID, 'chandelier_elated_square');
					...
					<div class = "eltd-blog-single-prev-info">
						<div class="eltd-blog-navigation-info-holder clearfix">
							...
							<span class ="eltd-blog-navigation-info">
								<?php esc_html_e( 'Previous post', 'chandelier' )?>
							</span>
							</a>
						</div>
			...
			<?php if(get_next_post() != ""){ ?>
				<div class="eltd-blog-single-next-holder">
					<div class = "eltd-blog-single-next-info clearfix">
						...
						<span class ="eltd-blog-navigation-info">
							<?php esc_html_e( 'Next post', 'chandelier' )?>
						</span>
					...
					if(has_post_thumbnail($next_post->ID)){?>
						<div class="eltd-blog-single-next">
							<?php
							$next_post_image = get_the_post_thumbnail($next_post->ID, 'chandelier_elated_square');
