<?php  chandelier_elated_get_module_template_part('templates/lists/parts/filter', 'blog'); ?>
<div class="eltd-blog-holder eltd-blog-type-masonry eltd-masonry-pagination-<?php echo chandelier_elated_options()->getOptionValue('masonry_pagination'); ?>">
...
<?php
	if(chandelier_elated_options()->getOptionValue('pagination') == 'yes') {
		...
		$pagination_type = chandelier_elated_options()->getOptionValue('masonry_pagination');
