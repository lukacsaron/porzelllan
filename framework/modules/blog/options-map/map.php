...
if ( ! function_exists('chandelier_elated_blog_options_map') ) {

	function chandelier_elated_blog_options_map() {
		...
		$panel_blog_lists = chandelier_elated_add_admin_panel(
			array(
				'page' => '_blog_page',
		...
		if(count($custom_sidebars) > 0) {
			chandelier_elated_add_admin_field(array(
				...
				'parent' => $panel_blog_lists,
				'options' => chandelier_elated_get_custom_sidebars()
			));
		}
		...
		$pagination_container = chandelier_elated_add_admin_container(
			array(
		 ...
		 * Blog Single
		 */
		$panel_blog_single = chandelier_elated_add_admin_panel(
			array(
				'page' => '_blog_page',
		...
		$blog_single_navigation_container = chandelier_elated_add_admin_container(
			array(
		...
		$blog_single_author_info_container = chandelier_elated_add_admin_container(
			array(
	...
	add_action( 'chandelier_elated_options_map', 'chandelier_elated_blog_options_map', 18);
