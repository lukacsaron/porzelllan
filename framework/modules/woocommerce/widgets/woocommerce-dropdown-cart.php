<?php
class ChandelierWoocommerceDropdownCart extends WP_Widget {
	public function __construct() {
		parent::__construct(
			'eltd_woocommerce_dropdown_cart', // Base ID
			'Elated Woocommerce Dropdown Cart', // Name
			array( 'description' => esc_html__( 'Elated Woocommerce Dropdown Cart', 'chandelier' ), ) // Args
		);
	}
					...
					<div class="eltd-shopping-cart-dropdown">
						...
						<ul>
							...
							<?php if ( !$cart_is_empty ) : ?>
									...
									<li>
										...
										<div class="eltd-item-info-holder">
											<div class="eltd-item-left">
												...
												<span class="eltd-quantity"><?php esc_html_e('Quantity: ','chandelier'); echo esc_html($cart_item['quantity']); ?></span>
											</div>
											<div class="eltd-item-right">
												<?php echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf('<a href="%s" class="remove" title="%s">&times;</a>', esc_url( $woocommerce->cart->get_remove_url( $cart_item_key ) ), esc_html__('Remove this item', 'chandelier') ), $cart_item_key ); ?>
											</div>
										</div>
									</li>
								...
								<div class="eltd-cart-bottom">
									<div class="eltd-subtotal-holder clearfix">
										<span class="eltd-total"><?php esc_html_e( 'Total', 'chandelier' ); ?>:</span>
									...
									<div class="eltd-btns-holder clearfix">
										<?php $add_to_cart = chandelier_elated_get_button_html(array(
												'link' => $woocommerce->cart->get_cart_url(),
												'text' => esc_html__( 'Shopping Bag', 'chandelier' ),
										...
										<?php $add_to_cart = chandelier_elated_get_button_html(array(
												...
												'text' => esc_html__( 'Checkout', 'chandelier' ),
							...
							<?php else : ?>
								...
								<li class="eltd-empty-cart"><?php esc_html_e( 'No products in the cart.', 'chandelier' ); ?></li>
...
add_action( 'widgets_init', create_function( '', 'register_widget( "ChandelierWoocommerceDropdownCart" );' ) );
?>
<?php
add_filter('add_to_cart_fragments', 'chandelier_elated_woocommerce_header_add_to_cart_fragment');
function chandelier_elated_woocommerce_header_add_to_cart_fragment( $fragments ) {
	global $woocommerce;
