...
if(!function_exists('chandelier_elated_get_wpml_pages_for_current_page')) {
	/**
	 ...
	 * @version 0.1
	 */
	function chandelier_elated_get_wpml_pages_for_current_page() {
		$wpml_pages_for_current_page = array();

		if(chandelier_elated_is_wpml_installed()) {
