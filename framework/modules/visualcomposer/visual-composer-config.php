...
if ( ! function_exists('chandelier_elated_configure_visual_composer') ) {
	/**
	 * Configuration for Visual Composer
	 * Hooks on vc_after_init action
	 */
	function chandelier_elated_configure_visual_composer() {
	...
	add_action('vc_after_init', 'chandelier_elated_configure_visual_composer');

}


if ( ! function_exists('chandelier_elated_configure_visual_composer_grid_elemets') ) {
	...
	function chandelier_elated_configure_visual_composer_grid_elemets() {
	...
	add_action('vc_after_init', 'chandelier_elated_configure_visual_composer_grid_elemets');
}


if ( ! function_exists('chandelier_elated_configure_visual_composer_frontend_editor') ) {
	/**
	 * Configuration for Visual Composer FrontEnd Editor
	 * Hooks on vc_after_init action
	 */
	function chandelier_elated_configure_visual_composer_frontend_editor() {
	...
	add_action('vc_after_init', 'chandelier_elated_configure_visual_composer_frontend_editor');
}
...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	...
	class WPBakeryShortCode_Eltd_Tab extends WPBakeryShortCodesContainer {}
	...
	class WPBakeryShortCode_Eltd_Pricing_Tables extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_Eltd_Process_Holder extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_Eltd_Cover_Boxes_Holder extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_Eltd_Team_Holder extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_Eltd_Image_Waterfall extends WPBakeryShortCodesContainer {}
	class WPBakeryShortCode_Eltd_Image_Waterfall_Heading extends WPBakeryShortCodesContainer {}
	
}

if ( class_exists( 'WPBakeryShortCode' ) ) {
	class WPBakeryShortCode_Eltd_Pricing_Table extends WPBakeryShortCode {}
	class WPBakeryShortCode_Eltd_Process extends WPBakeryShortCode {}
	class WPBakeryShortCode_Eltd_Cover_Boxes_Item extends WPBakeryShortCode {}
	class WPBakeryShortCode_Eltd_Team extends WPBakeryShortCode {}
}

/*** Row ***/
if ( ! function_exists('chandelier_elated_vc_row_map') ) {
	/**
	 * Map VC Row shortcode
	 * Hooks on vc_after_init action
	 */
	function chandelier_elated_vc_row_map()
	{
	...
	add_action('vc_after_init', 'chandelier_elated_vc_row_map');
}
