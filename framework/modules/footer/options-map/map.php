...
if ( ! function_exists('chandelier_elated_footer_options_map') ) {
	/**
	 * Add footer options
	 */
	function chandelier_elated_footer_options_map() {
		...
		$footer_panel = chandelier_elated_add_admin_panel(
			array(
				'title' => 'Footer',
				'name' => 'footer',
				'page' => '_footer_page'
		...
		$show_footer_top_container = chandelier_elated_add_admin_container(
			array(
		...
		$show_footer_bottom_container = chandelier_elated_add_admin_container(
			array(
	...
	add_action( 'chandelier_elated_options_map', 'chandelier_elated_footer_options_map', 15);
