<?php
if ( ! function_exists('chandelier_elated_contact_form_map') ) {
	/**
	 * Map Contact Form 7 shortcode
	 * Hooks on vc_after_init action
	 */
	function chandelier_elated_contact_form_map()
	{
	...
	add_action('vc_after_init', 'chandelier_elated_contact_form_map');
}
?>