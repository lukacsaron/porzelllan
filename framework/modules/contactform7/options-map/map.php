...
if ( ! function_exists('chandelier_elated_contact_form_7_options_map') ) {

	function chandelier_elated_contact_form_7_options_map() {
		...
		$panel_contact_form_style_1 = chandelier_elated_add_admin_panel(array(
		...
		$typography_text_group = chandelier_elated_add_admin_group(array(
		...
		$typography_text_row1 = chandelier_elated_add_admin_row(array(
		...
		$typography_text_row2 = chandelier_elated_add_admin_row(array(
		...
		$typography_text_row3 = chandelier_elated_add_admin_row(array(
		...
		$typography_label_group = chandelier_elated_add_admin_group(array(
		...
		$typography_label_row1 = chandelier_elated_add_admin_row(array(
		...
		$typography_label_row2 = chandelier_elated_add_admin_row(array(
		...
		$background_border_group = chandelier_elated_add_admin_group(array(
		...
		$background_border_row1 = chandelier_elated_add_admin_row(array(
		...
		$background_border_row2 = chandelier_elated_add_admin_row(array(
		...
		$background_border_row3 = chandelier_elated_add_admin_row(array(
		...
		$padding_group = chandelier_elated_add_admin_group(array(
			'name'			=> 'padding_group',
		...
		$padding_row = chandelier_elated_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		$margin_group = chandelier_elated_add_admin_group(array(
			'name'			=> 'margin_group',
		...
		$margin_row = chandelier_elated_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = chandelier_elated_add_admin_group(array(
		...
		$button_typography_row1 = chandelier_elated_add_admin_row(array(
		...
		$button_typography_row2 = chandelier_elated_add_admin_row(array(
		...
		$button_background_border_group = chandelier_elated_add_admin_group(array(
		...
		$button_background_border_row1 = chandelier_elated_add_admin_row(array(
		...
		$button_background_border_row2 = chandelier_elated_add_admin_row(array(
		...
		$button_background_border_row3 = chandelier_elated_add_admin_row(array(
		...
		$panel_contact_form_style_2 = chandelier_elated_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
	...
	add_action( 'chandelier_elated_options_map', 'chandelier_elated_contact_form_7_options_map', 24);
