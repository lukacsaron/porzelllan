<?php
namespace Chandelier\Modules\PricingTable;
...
class PricingTable implements ShortcodeInterface{
	...
	public function render($atts, $content = null) {
		...
		$html .= chandelier_elated_get_shortcode_module_template_part('templates/pricing-table-template','pricing-table', '', $params);
		return $html;
