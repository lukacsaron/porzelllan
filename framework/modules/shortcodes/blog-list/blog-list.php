...
namespace Chandelier\Modules\BlogList;
...
class BlogList implements ShortcodeInterface {
	...
	*/
		...
		vc_map( array(
			...
			'params' => array(
					array(
						...
						'holder' => 'div',
						'class' => '',
						'heading' => esc_html__('Type', 'chandelier'),
						'param_name' => 'type',
						'value' => array(
							'Boxes' => 'boxes',
							'Masonry' => 'masonry',
	...
	public function render($atts, $content = null) {
		...
		$html ='';
        $html .= chandelier_elated_get_shortcode_module_template_part('templates/blog-list-holder', 'blog-list', '', $params);
		return $html;
	...
	*/
	private function generateImageSize($params){
		...
		if ($imageSize !== '' && $imageSize == 'landscape') {
            $thumbImageSize .= 'chandelier_elated_landscape';
        } else if($imageSize === 'square'){
			$thumbImageSize .= 'chandelier_elated_square';
