<?php
namespace Chandelier\Modules\Shortcodes\ImageGallery;
...
class ImageGallery implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map(array(
			...
			'base'                      => $this->getBase(),
			'category'                  => 'by ELATED',
			'icon'                      => 'icon-wpb-img-gallery extended-custom-icon',
	...
	public function render($atts, $content = null) {
		...
		$html = chandelier_elated_get_shortcode_module_template_part('templates/' . $template, 'imagegallery', '', $params);
