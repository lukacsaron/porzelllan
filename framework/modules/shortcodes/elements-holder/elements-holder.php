<?php
namespace Chandelier\Modules\ElementsHolder;
...
class ElementsHolder implements ShortcodeInterface{
	...
	public function render($atts, $content = null) {
		...
		$html .= '<div ' . chandelier_elated_get_class_attribute($elements_holder_class) . ' ' . chandelier_elated_get_inline_attr($elements_holder_style, 'style'). '>';
