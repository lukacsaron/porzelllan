<?php
namespace Chandelier\Modules\ElementsHolderItem;
...
class ElementsHolderItem implements ShortcodeInterface{
	...
	public function vcMap() {
		if(function_exists('vc_map')){
			vc_map( 
				array(
					'name' => 'Elements Holder Item', 'chandelier',
					'base' => $this->base,
	...
	public function render($atts, $content = null) {
		...
		$html = chandelier_elated_get_shortcode_module_template_part('templates/elements-holder-item-template', 'elements-holder', '', $params);
