<?php
namespace Chandelier\Modules\PieCharts\PieChartBasic;
...
class PieChartBasic implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = chandelier_elated_get_shortcode_module_template_part('templates/pie-chart-basic', 'piecharts/piechartbasic', '', $params);
