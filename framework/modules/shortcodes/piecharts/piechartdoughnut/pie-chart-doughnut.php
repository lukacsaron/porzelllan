<?php
namespace Chandelier\Modules\PieCharts\PieChartDoughnut;
...
class PieChartDoughnut implements ShortcodeInterface {
	...
	public function __construct() {
		$this->base = 'eltd_pie_chart_doughnut';
	...
	public function render($atts, $content = null) {
		...
		$html = chandelier_elated_get_shortcode_module_template_part('templates/pie-chart-doughnut', 'piecharts/piechartdoughnut', '', $params);
