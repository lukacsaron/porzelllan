...
class Separator implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map(
			array(
				...
				'base' => $this->base,
				'category' => 'by ELATED',
				'icon' => 'icon-wpb-horizontal-separator extended-custom-icon',
	...
	public function render($atts, $content = null) {
		...
		$html = chandelier_elated_get_shortcode_module_template_part('templates/separator-template', 'separator', '', $params);
	...
	private function getSeparatorStyle($params) {
		...
		if ($params['width'] !== '') {
			if(chandelier_elated_string_ends_with($params['width'], '%') || chandelier_elated_string_ends_with($params['width'], 'px')) {
		...
		if ($params['top_margin'] !== '') {
			if(chandelier_elated_string_ends_with($params['top_margin'], '%') || chandelier_elated_string_ends_with($params['top_margin'], 'px')) {
		...
		if ($params['bottom_margin'] !== '') {
			if(chandelier_elated_string_ends_with($params['bottom_margin'], '%') || chandelier_elated_string_ends_with($params['bottom_margin'], 'px')) {
