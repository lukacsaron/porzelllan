...
if(!function_exists('chandelier_elated_single_portfolio')) {
    function chandelier_elated_single_portfolio() {
        $portfolio_template = chandelier_elated_get_portfolio_single_type();
        ...
        if ($portfolio_template == 'gallery') {
            $params['holder_class'][] = 'eltd-portfolio-gallery-' . chandelier_elated_options()->getOptionValue('portfolio_single_numb_columns');
        }

        chandelier_elated_get_module_template_part('templates/single/holder', 'portfolio', '', $params);
    }
}

if(!function_exists('chandelier_elated_get_portfolio_single_type')) {
    function chandelier_elated_get_portfolio_single_type() {
        return chandelier_elated_get_meta_field_intersect('portfolio_single_template');
    }
}

if(!function_exists('chandelier_elated_get_portfolio_single_media')) {
    function chandelier_elated_get_portfolio_single_media() {
        ...
        if(is_array($videos) && count($videos)) {
            usort($videos, 'chandelier_elated_compare_portfolio_videos');
            foreach($videos as $video) {
                ...
                if(!empty($video['portfoliovideotype'])) {
                    ...
                    $media['video_url']   = chandelier_elated_portfolio_get_video_url($video);
...
if(!function_exists('chandelier_elated_portfolio_get_video_url')) {
    function chandelier_elated_portfolio_get_video_url($video) {
...
if(!function_exists('chandelier_elated_portfolio_get_media_html')) {
    function chandelier_elated_portfolio_get_media_html($media) {
        global $wp_filesystem;
        $params = array();

        //For adding image overlay in gallery template type
        $params['gallery'] = (chandelier_elated_get_portfolio_single_type() == 'gallery') ? true : false;

        if($media['type'] == 'image') {
            $params['lightbox'] = chandelier_elated_options()->getOptionValue('portfolio_single_lightbox_images') == 'yes';
        ...
        if(in_array($media['type'], array('youtube', 'vimeo'))) {
            $params['lightbox'] = chandelier_elated_options()->getOptionValue('portfolio_single_lightbox_videos') == 'yes';
        ...
        chandelier_elated_get_module_template_part('templates/single/media/'.$media['type'], 'portfolio', '', $params);
    }
}

if(!function_exists('chandelier_elated_compare_portfolio_videos')) {
    /**
     ...
     */
    function chandelier_elated_compare_portfolio_videos($a, $b) {
...
if(!function_exists('chandelier_elated_compare_portfolio_options')) {
    /**
     ...
     * @return int result of comparison
     */
    function chandelier_elated_compare_portfolio_options($a, $b) {
...
if(!function_exists('chandelier_elated_portfolio_get_info_part')) {
    function chandelier_elated_portfolio_get_info_part($part) {
        $portfolio_template = chandelier_elated_get_portfolio_single_type();

        chandelier_elated_get_module_template_part('templates/single/parts/'.$part, 'portfolio', $portfolio_template);
    }
}