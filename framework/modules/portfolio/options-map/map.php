...
if ( ! function_exists('chandelier_elated_portfolio_options_map') ) {

	function chandelier_elated_portfolio_options_map() {
		...
		$container_navigate_category = chandelier_elated_add_admin_container(array(
	...
	add_action( 'chandelier_elated_options_map', 'chandelier_elated_portfolio_options_map', 19);
