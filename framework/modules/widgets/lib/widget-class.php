 ...
 *
 * Class ChandelierWidget
 */
abstract class ChandelierWidget extends WP_Widget {
    /**
    ...
    public function form($instance) {
        if(is_array($this->params) && count($this->params)) {
            ...
            <p><?php esc_html_e('There are no options for this widget.', 'chandelier'); ?></p>
        <?php }
    }
...
$chandelier_elated_Framework = ChandelierFramework::get_instance();
$eltdSkinManager = new ChandelierSkinManager();
$chandelier_elated_Framework->setSkin($eltdSkinManager->getSkin());
