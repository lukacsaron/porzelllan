...
<?php do_action('chandelier_elated_before_header_top'); ?>

<div class="eltd-top-bar">
    <?php if($top_bar_in_grid) : ?>
    <div class="eltd-grid">
    <?php endif; ?>
		<?php do_action( 'chandelier_elated_after_header_top_html_open' ); ?>
...
<?php do_action('chandelier_elated_after_header_top'); ?>
