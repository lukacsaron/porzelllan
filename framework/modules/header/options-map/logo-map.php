...
if ( ! function_exists('chandelier_elated_logo_options_map') ) {

	function chandelier_elated_logo_options_map() {
		...
		$panel_logo = chandelier_elated_add_admin_panel(
			array(
				'page' => '_logo_page',
				'name' => 'panel_logo',
				'title' => 'Logo'
		...
		$hide_logo_container = chandelier_elated_add_admin_container(
			array(
				'parent' => $panel_logo,
	...
	add_action( 'chandelier_elated_options_map', 'chandelier_elated_logo_options_map', 6);
